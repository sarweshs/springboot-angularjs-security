...
<body ng-app="myApp" class="ng-cloak">
	<div class="generic-container" ng-controller="UserController as ctrl">
		<div class="panel panel-default">
			<div class="panel-heading">
				<span class="lead">User Registration Form </span><span class="lead"><a href="<c:url value="/logout" />">Logout</a></span>
			</div>
			<div class="formcontainer">
				<form ng-submit="ctrl.submit()" name="myForm"
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-2 control-lable" for="file">Roles</label>
							<div class="col-md-7">
								<label ng-repeat="role in ctrl.roles"> <input type="checkbox" checklist-model="ctrl.user.roles" checklist-value="role" >
									{{role.roleName}}
								</label> 
							</div>
						</div>
						...
						<tr ng-repeat="u in ctrl.users">
							...
							<td>
								<button type="button" ng-click="ctrl.edit(u.id)"
									...
									ng-disabled="u.createdBy=='SYSTEM' || u.status != 'DRAFT'">Edit</button>
								<button type="button" ng-click="ctrl.remove(u.id)"
									class="btn btn-danger custom-width"
									ng-disabled="u.createdBy=='SYSTEM'">Remove</button>
							</td>
						</tr>
					</tbody>
				</table>
	...
	<script src="<c:url value='/static/js/checklist-model.js' />"></script>
