                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.users">
                              ...
                              <td>
                              <button type="button" ng-click="ctrl.edit(u.id)" class="btn btn-success custom-width" ng-disabled="u.createdBy=='SYSTEM' || u.status != 'DRAFT'">Edit</button>  <button type="button" ng-click="ctrl.remove(u.id)" class="btn btn-danger custom-width" ng-disabled="u.createdBy=='SYSTEM'">Remove</button>
                              </td>
                          </tr>
                      </tbody>
                  </table>
